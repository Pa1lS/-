document.addEventListener("DOMContentLoaded", function () {
  ...
  function calculateFinalScore() {
    ...
    charisma *=
      getBaseCoefficient(charisma) *
      getAdditionalCoefficient(charisma);
    vibe *=
      getBaseCoefficient(vibe) *
      getAdditionalCoefficient(vibe);

    let weightedScore =
      rhythm + rhyme + wealth + imagery + charisma + vibe;

    let maxPossibleScore =
      10 * getBaseCoefficient(10) * 4 +
      10 *
        getBaseCoefficient(10) *
        getAdditionalCoefficient(10) *
        2;
